...
<head>
    ...
    <!-- Main Styling -->
    <link href="{{ asset('back/css/soft-ui-dashboard-tailwind.css') }}" rel="stylesheet" />
    <link href="{{ asset('back/css/perfect-scrollbar.css') }}" rel="stylesheet" />
...
<body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    {{-- <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#"><small>
    ...
    <script src="{{ asset('back/js/navbar-sticky.js') }}" async></script>
    <!-- plugin for scrollbar  -->
    <script src="{{ asset('back/js/plugins/perfect-scrollbar.min.js') }}" async></script>
    <!-- github button -->
    <script async defer src="https://buttons.github.io/buttons.js"></script>
    <!-- main script file  -->
    <script src="{{ asset('back/js/soft-ui-dashboard-tailwind.js') }}" async></script>
